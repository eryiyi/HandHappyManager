    ...
    <div class="row">
        <div id="sidebar-left" class="col-xs-4 col-sm-2">
            <ul class="nav main-menu">
                ...
                ||um:permission('LIST_EMPLOYEE_CHENGXIN', sessionScope.powers)
                ||um:permission('LIST_EMPLOYEE_RENZHENG', sessionScope.powers)
                ||um:permission('LIST_EMPLOYEE_SHENFEN', sessionScope.powers)
                }">
                    <li class="dropdown">
                        <a href="javascript:void (0);" class="dropdown-toggle">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <c:if test="${um:permission('LIST_EMPLOYEE_SHENFEN', sessionScope.powers)}">
                                <li><a href="javascript:void(0);" onclick="toPage('/emp/listsf','1')">身份认证</a></li>
                            </c:if>

                            <c:if test="${um:permission('LIST_EMPLOYEE_RENZHENG', sessionScope.powers)}">
                                <li><a href="javascript:void(0);" onclick="toPage('/emp/listhy','1')">会员认证</a></li>
                            </c:if>

                            <c:if test="${um:permission('LIST_EMPLOYEE_CHENGXIN', sessionScope.powers)}">
                                <li><a href="javascript:void(0);" onclick="toPage('/emp/listcx','1')">诚信认证</a></li>
                            </c:if>
                        </ul>
                    </li>
                </c:if>
